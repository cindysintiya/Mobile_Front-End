...
class NotificationProvider extends ChangeNotifier {
  ...
  final List<Map> _allNotif = [
    ...
    {'id': 4, 'title': 'Sudah waktunya Pick-Up', 'body': 'Kriinggg... Masih inget pesanan Burger yang kamu jadwalkan untuk diambil pukul 13:47? Kamu udah bisa datang ke store untuk cek apakah Burger-mu udah siap dan nikmatilah selagi fresh *chef kiss*', 'date': '25-04-2023 13:47', 'type': 'Order', 'read': false},
