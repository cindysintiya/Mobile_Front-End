...
class _OrderScreenState extends State<OrderScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return provOrder.myOrder.isNotEmpty? SingleChildScrollView(
      child: Padding(
          ...
          children: provOrder.myOrder.map((order) {
            return Padding(
              ...
              child: Card(
                ...
                color: const Color.fromRGBO(255, 240, 211, 1),
                child: InkWell(
                  onTap: () {
                    showDialog(
                      context: context, 
                    ...
                    children: [
                      Container(
                        decoration: const BoxDecoration(
                          color: Color.fromRGBO(255, 231, 186, 1),
                        ),
                        padding: const EdgeInsets.all(10),
                        ...
                        child: Wrap(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(order['Contact']['Waktu'], style: const TextStyle(fontSize: 18),),
                            ),
                            PopupMenuButton(
                      ...
                      Wrap(
                        ...
                        crossAxisAlignment: WrapCrossAlignment.center,
                        children: [
                          SizedBox(width: MediaQuery.of(context).size.width*0.25, child: StackBurger(source: order, padding: 10, width: 150,)),
                          SizedBox(
